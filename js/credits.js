...
const CAST = [
  ...
  { re: /^(brownie)/i, art: 'assets/enemies/boss_brownie.jpg', emoji: '🦆', name: 'Brownie', title: 'Queen of the Crop Kingdom' },
  { re: /^(diver)/i, art: 'assets/enemies/boss_diver.jpg', emoji: '🦆', name: 'Diver', title: 'Ruler of the Pond' },
  { re: /^(harmless)/i, art: 'assets/enemies/boss_harmless.jpg', emoji: '🦆', name: 'Harmless', title: 'The Warning Label' },
