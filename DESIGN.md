...
- **Pet roster direction (boys' round, Sun 2026-08-16 + James):** animals — pigs, chickens, **multiple dog breeds** ("to make it a little bit harder" — breed variants add collection depth), raccoons, cats, and **fish, who get their own little fish pool at the farm** instead of the barn ("to make it a little bit more realistic"); plus **a really, really, really rare ALIEN pet** (the rarest thing in the game). James: use what fits, and for remaining roster gaps Hugo takes **extreme creative liberty** — really weird pets welcome to match the World of Weirdos register.
- **Weirdo casts:** James grants extreme creative liberty — make them genuinely weird.
